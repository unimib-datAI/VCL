...
def integra(context, what, how, llm, language) -> tuple[str, dict]:
    state = {
        "how": how,
        "context": context,
        "guidelines": language.get_guidelines_from_command("integra"),
        "command": "integra", 
        "description_command": language.get_description_from_command("integra"),
        "what": what[0],
