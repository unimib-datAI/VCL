    ...
    if commands and sources and what:
        ...
        for cmd in commands:
            ...
            if what_cmd:
                ...
                what_info = "- Si tratta di un comando non atomico. In base al valore di WHAT e il numero di elementi in FROM verranno eseguite una serie di comandi elementari"
