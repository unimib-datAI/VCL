...
def _call_assistant_thread(
    ...
    """
    try:
        response = _call_model(prompt, selected_model, assistant, username, storage, chat_id)
...
# -------------------------------
# --- Document helpers (thread-safe)
# -------------------------------

def _load_case_documents(storage, username: str) -> List[Dict[str, str]]:
    """
...
def _ask_gpt(prompt: str, assistant, username: str, storage) -> Dict:
...
def _ask_battle(prompt: str, assistant, username: str, storage, anonymized: bool, chat_id) -> Dict:
    """
    Modalità Battle:
    ...
    ans_a = _run_single_model_for_battle(model_a, prompt, assistant, username, storage, chat_id)
    ans_b = _run_single_model_for_battle(model_b, prompt, assistant, username, storage, chat_id)
...
def _run_single_model_for_battle(model_key: str, prompt: str, assistant, username: str, storage, chat_id) -> Dict[str, str]:
    """
...
def _call_model(prompt: str, selected_model: str, assistant, username: str, storage, chat_id):
    """
    ...
    if selected_model == "DQL":
        ...
        return _ask_battle(prompt, assistant, username, storage, True, chat_id)

    elif selected_model == "BattleLabeled":
        return _ask_battle(prompt, assistant, username, storage, False, chat_id)
