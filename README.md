...
5. Make sure you are connected to your university's VPN — this is required to access the Elasticsearch database.
6. Start the graph. Run the following command:
```bash
